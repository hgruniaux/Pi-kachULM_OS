...
#define PROCESS_STACK_PAGE_SIZE (2)        // 2 * 4096 bytes
...
#define PROCESS_STACK_PAGE_TOP (PROCESS_BASE + 0x0000f00000000000 + PHYSICAL_STACK_TOP)
#define PROCESS_STACK_PAGE_BOTTOM (PROCESS_STACK_PAGE_TOP + PROCESS_STACK_PAGE_SIZE * PAGE_SIZE - PAGE_SIZE)
